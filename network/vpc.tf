module "vpc_web" {
  ...
  role                       = "frontend-vpc"
  tgw_attachment_dep         = module.tgw_web_attachment.this
}
...
module "vpc_app" {
  ...
  role                       = "Backend-vpc"
  tgw_attachment_dep         = module.tgw_app_attachment.this
...
module "vpc_db" {
  ...
  role                       = "Database-vpc"
  tgw_attachment_dep         = module.tgw_db_attachment.this
...
module "vpc_shared" {
  ...
  role                       = "Shared-vpc"
  tgw_attachment_dep         = module.tgw_shared_attachment.this
}
...
module "vpc_onprem" {
  ...
  enable_nat_gateway         = false
  role                       = "Onprem-vpc"
  tgw_attachment_dep         = module.tgw_onprem_attachment.this
}
